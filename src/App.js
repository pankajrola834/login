            ...
            <div className="col">
              <div className="card card-registration my-4 ">
                <div className="row g-0">
                  <div className="col-xl-6 mt-5 pt-5 d-none d-xl-block">
                    <img src="https://c0.wallpaperflare.com/preview/598/410/409/login-monitor-smartphone-tablet.jpg"
                      alt="Sample photo" className="img-fluid mt-5 pt-5"
                    />
                  </div>
                    ...
                    <div className="card-body p-md-5 text-black">
                      ...
                      <div className="row">
                        <div className="col-md-6 mb-4">
                          ...
                          <label className="form-label" for="form3Example1m1">State</label>

                        </div>
                        <div className="col-md-6 mb-4">

                          <input type="text" id="form3Example1m1" className="form-control form-control-lg" />
                          <label className="form-label" for="form3Example1m1">City</label>
